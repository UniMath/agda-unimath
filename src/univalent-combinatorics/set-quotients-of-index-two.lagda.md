...
module _
  ...
  (H : {x y : A} →
    sim-Eq-Relation R x y ↔ sim-Eq-Relation R (h x) (h y))
  (h' : type-Set QR → type-Set QR)
  (x : A)
  (P :
    h' (map-reflecting-map-Eq-Relation R f x) ＝
    map-reflecting-map-Eq-Relation R f (h x))
  where

  cases-coherence-square-maps-eq-one-value-emb-is-set-quotient :
    is-emb h' →
    (y : A) (k k' k'' : Fin 2) →
    map-equiv eA (h' (map-reflecting-map-Eq-Relation R f x)) ＝ k →
    map-equiv eA (h' (map-reflecting-map-Eq-Relation R f y)) ＝ k' →
    map-equiv eA (map-reflecting-map-Eq-Relation R f (h y)) ＝ k'' →
    h' (map-reflecting-map-Eq-Relation R f y) ＝
    map-reflecting-map-Eq-Relation R f (h y)
  cases-coherence-square-maps-eq-one-value-emb-is-set-quotient H' y
    ...
    ( is-injective-map-equiv eA (q ∙ inv p)) ∙
      ( P ∙
        reflects-map-reflecting-map-Eq-Relation R f
          ( pr1 H
            ( map-equiv
  ...
  coherence-square-maps-eq-one-value-emb-is-set-quotient H' y =
    cases-coherence-square-maps-eq-one-value-emb-is-set-quotient H' y
      ( map-equiv eA (h' (map-reflecting-map-Eq-Relation R f x)))
      ( map-equiv eA (h' (map-reflecting-map-Eq-Relation R f y)))
      ( map-equiv eA (map-reflecting-map-Eq-Relation R f (h y)))
      ( refl)
      ( refl)
      ( refl)
