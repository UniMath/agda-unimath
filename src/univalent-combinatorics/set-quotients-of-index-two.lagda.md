...
module _
  ...
  cases-commuting-square-eq-one-value-emb-is-set-quotient : is-emb h' →
    (y : A) (k k' k'' : Fin 2) → 
  ...
  cases-commuting-square-eq-one-value-emb-is-set-quotient H' y
  ...
  commuting-square-eq-one-value-emb-is-set-quotient : is-emb h' →
    commuting-square
      ( h)
      ( map-reflecting-map-Eq-Rel R f)
      ( map-reflecting-map-Eq-Rel R f)
      ( h')
  commuting-square-eq-one-value-emb-is-set-quotient H' y =
    cases-commuting-square-eq-one-value-emb-is-set-quotient H' y
  ...
  eq-equiv-eq-one-value-equiv-is-set-quotient P Q =
    ap pr1
      { x =
        pair
          ( pair h' Q)
          ( commuting-square-eq-one-value-emb-is-set-quotient
            ( is-emb-is-equiv Q))}
      { y =
        center
