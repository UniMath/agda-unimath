...
analytic-comp-species {l1} {l2} {l3} S T X =
  Σ ( Σ-Decomposition-𝔽 l1 l1 (type-𝔽 X))
    ( λ D →
      ( S (finite-indexing-type-Σ-Decomposition-𝔽 D) ×
      ( (y : indexing-type-Σ-Decomposition-𝔽 D) →
...
### Equivalent form with general species
...
module _
  ...
  equiv-species-generalized-species :
    ( X : 𝔽 l1) →
    S X ≃ Σ-generalized-species S (type-𝔽 (X))
  equiv-species-generalized-species X =
