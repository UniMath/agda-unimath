...
untruncated-π-finite-𝔽 :
  {l : Level} (k : ℕ) → 𝔽 l → Untruncated-π-Finite-Type l k
untruncated-π-finite-𝔽 k A =
  ( type-𝔽 A , is-untruncated-π-finite-is-finite k (is-finite-type-𝔽 A))
```
