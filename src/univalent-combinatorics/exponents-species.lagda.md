...
```agda 
exponents-species : {l1 l2 : Level} → (F : species l1) → (G : species l2) → (X : 𝔽) → UU (l1 ⊔ l2)
...
universal-property-exponents-species F G H = (X : 𝔽) → F X → (exponents-species G H X)


universal-property-cartesian-prod-exponents-species : {l1 l2 l3 : Level} (F : species l1)(G : species l2)(H : species l3) → UU (lsuc lzero ⊔ l1 ⊔ l2 ⊔ l3)
universal-property-cartesian-prod-exponents-species F G H = (X : 𝔽) → (universal-property-exponents-species F G H) → (universal-property-exponents-species F G H)
```  
