...
module foundations.twin-prime-conjecture where

open import foundations.cartesian-product-types using (_×_)
open import foundations.dependent-pair-types using (Σ)
open import foundations.inequality-natural-numbers using (leq-ℕ)
open import foundations.levels using (UU; lzero)
open import foundations.natural-numbers using (ℕ; succ-ℕ)
