...
module foundations.divisibility-integers where

open import foundations.absolute-value-integers using (abs-ℤ; int-abs-ℤ)
open import foundations.addition-integers using (add-ℤ; ap-add-ℤ)
...
open import foundations.equality-integers using
...
open import foundations.natural-numbers using (ℕ; zero-ℕ; succ-ℕ; is-one-ℕ)
