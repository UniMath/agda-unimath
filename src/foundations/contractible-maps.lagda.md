...
module foundations.contractible-maps where
...
open import foundations.contractible-types using (is-contr; center; contraction)
...
open import foundations.fibers-of-maps using (fib; eq-Eq-fib)
open import foundations.functions using (_∘_; id)
open import foundations.homotopies using (_~_; _·r_; _·l_)
