...
module foundations.greatest-common-divisor-integers where

open import foundations.absolute-value-integers using
...
open import foundations.greatest-common-divisor-natural-numbers using
...
open import foundations.natural-numbers using (ℕ; is-zero-ℕ)
```
