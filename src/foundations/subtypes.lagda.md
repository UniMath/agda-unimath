...
open import foundations.1-types using (is-1-type)
...
open import foundations.equivalences using (is-equiv; _≃_; map-inv-is-equiv)
open import foundations.fibers-of-maps using (equiv-fib-pr1)
...
open import foundations.levels using (Level; UU; _⊔_; lsuc)
...
open import foundations.sets using (is-set; UU-Set; type-Set; is-set-type-Set)
open import foundations.truncated-types using (is-trunc; is-trunc-is-emb)
