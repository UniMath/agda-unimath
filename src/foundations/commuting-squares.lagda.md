...
module foundations.commuting-squares where

open import foundations.embeddings using
  ( map-eq-transpose-equiv'; map-eq-transpose-equiv)
open import foundations.equivalences using
  ( _≃_; map-equiv; map-inv-equiv; issec-map-inv-equiv)
open import foundations.functions using (_∘_)
open import foundations.homotopies using (_~_; _·l_; _·r_; _∙h_)
open import foundations.identity-types using (ap; inv; _∙_)
open import foundations.levels using (Level; UU; _⊔_)
```

# Commuting squares of functions
