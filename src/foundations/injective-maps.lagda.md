...
open import foundations.embeddings using (is-emb; _↪_; map-emb; is-emb-map-emb)
...
open import foundations.propositional-maps using (is-prop-map; is-prop-map-is-emb)
open import foundations.propositions using (is-equiv-is-prop)
open import foundations.sets using (is-set; is-set-prop-in-id)
```
