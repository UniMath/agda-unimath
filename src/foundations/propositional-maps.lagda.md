...
module foundations.propositional-maps where

open import foundations.contractible-types using (is-contr-equiv; is-contr)
...
open import foundations.identity-types using (Id; refl; ap; inv)
