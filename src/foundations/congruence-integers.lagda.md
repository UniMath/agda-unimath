...
module foundations.congruence-integers where
...
open import foundations.congruence-natural-numbers using (cong-ℕ)
...
open import foundations.divisibility-integers using
  ( div-ℤ; is-unit-ℤ; div-is-unit-ℤ; is-zero-div-zero-ℤ; div-sim-unit-ℤ;
    ...
    symm-sim-unit-ℤ)
open import foundations.distance-integers using (dist-int-ℕ)
