...
module foundations.singleton-induction where

open import foundations.contractible-types using (is-contr; contraction)
open import foundations.dependent-pair-types using (Σ; pair; pr1; pr2; ind-Σ)
open import foundations.equivalences using (sec)
open import foundations.functions using (ev-pt; _∘_; id)
...
open import foundations.levels using (Level; UU; lsuc; _⊔_)
open import foundations.unit-type using (unit; star; ind-unit)
```
