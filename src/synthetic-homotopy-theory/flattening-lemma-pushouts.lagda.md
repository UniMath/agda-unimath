...
module _
  ...
  ( Q : X → UU l5)
  ( e :
    equiv-structure-type-family-pushout P
      ( structure-type-family-pushout-type-family c Q))
  where

  vertical-map-span-flattening-descent-data-pushout :
    Σ (spanning-type-span s) (left-type-family-structure-type-family-pushout s P ∘ left-map-span s) → Σ (domain-span s) (left-type-family-structure-type-family-pushout s P)
  vertical-map-span-flattening-descent-data-pushout =
    map-Σ-map-base (left-map-span s) (left-type-family-structure-type-family-pushout s P)

  horizontal-map-span-flattening-descent-data-pushout :
    Σ (spanning-type-span s) (left-type-family-structure-type-family-pushout s P ∘ left-map-span s) → Σ (codomain-span s) (right-type-family-structure-type-family-pushout s P)
  horizontal-map-span-flattening-descent-data-pushout =
    map-Σ (right-type-family-structure-type-family-pushout s P) (right-map-span s) (map-matching-equiv-structure-type-family-pushout s P)

  horizontal-map-cocone-flattening-descent-data-pushout :
    Σ (domain-span s) (left-type-family-structure-type-family-pushout s P) → Σ X Q
  horizontal-map-cocone-flattening-descent-data-pushout =
    map-Σ Q
      ( horizontal-map-cocone-span s c)
      ( λ a → map-left-equiv-equiv-structure-type-family-pushout s P e a)
