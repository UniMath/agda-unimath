...
An extremely important special case of pushouts is the suspension of a type.
Given a type `X : UU`, we always have a span `unit <-- X --> unit`. The
suspension of `X` is the pushout of this span. Important examples of
suspensions include the spheres.
