...
Preorder l1 l2 =
  Σ ( UU l1)
    ( λ X →
      Σ ( Rel-Prop l2 X)
        ( λ R →
          ( is-reflexive (type-Rel-Prop R)) ×
          ( is-transitive (type-Rel-Prop R))))
...
module _
  ...
  leq-Preorder-Prop : Rel-Prop l2 type-Preorder
  ...
  is-prop-leq-Preorder = is-prop-type-Rel-Prop leq-Preorder-Prop
