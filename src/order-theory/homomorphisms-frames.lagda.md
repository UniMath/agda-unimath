...
module _
  ...
  hom-Frame = Σ (element-Frame A → element-Frame B)
    (λ f → preserves-order-Poset (poset-Frame A) (poset-Frame B) f ×
      (preserves-meets (meet-semilattice-Frame A) (meet-semilattice-Frame B) f ×
      preserves-sups (sup-lattice-Frame A) (sup-lattice-Frame B) f))
  ...
  preserves-meet-hom-Frame : (H : hom-Frame) → preserves-meets (meet-semilattice-Frame A) (meet-semilattice-Frame B) (map-hom-Frame H)
  preserves-meet-hom-Frame = pr1 ∘ (pr2 ∘ pr2) 

  preserves-sup-hom-Frame : (H : hom-Frame) → preserves-sups (sup-lattice-Frame A) (sup-lattice-Frame B) (map-hom-Frame H)
  preserves-sup-hom-Frame = pr2 ∘ (pr2 ∘ pr2)
