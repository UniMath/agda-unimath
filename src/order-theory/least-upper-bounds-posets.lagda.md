...
module _
  ...
  has-least-binary-upper-bound-Poset x y =
    Σ (type-Poset P) (is-least-binary-upper-bound-Poset x y)

  all-types-equal-has-least-binary-upper-bound-Poset :
    (x y : type-Poset P) →
    all-elements-equal (has-least-binary-upper-bound-Poset x y)
  all-types-equal-has-least-binary-upper-bound-Poset x y
    (pair u H) (pair v K) =
    eq-type-subtype
  ...
  is-prop-has-least-binary-upper-bound-Poset :
    (x y : type-Poset P) → is-prop (has-least-binary-upper-bound-Poset x y)
...
module _
  ...
  has-least-upper-bound-family-of-elements-Poset =
    Σ (type-Poset P) is-least-upper-bound-family-of-elements-Poset

  all-types-equal-has-least-upper-bound-family-of-elements-Poset :
