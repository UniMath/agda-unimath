...
compose-hom-Large-Precat Concrete-Group-Large-Precat {X = G} {Y = H} {Z = K} =
...
left-unit-law-compose-hom-Large-Precat Concrete-Group-Large-Precat
  ...
  eq-htpy-hom-Concrete-Group G H _ _
    ( left-unit-law-compose-hom-Concrete-Group G H f)
right-unit-law-compose-hom-Large-Precat Concrete-Group-Large-Precat
  {X = G} {Y = H} f =
  eq-htpy-hom-Concrete-Group G H _ _
    ( right-unit-law-compose-hom-Concrete-Group G H f)
```
