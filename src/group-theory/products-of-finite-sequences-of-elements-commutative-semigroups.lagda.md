...
module _
  ...
  htpy-product-fin-sequence-type-Commutative-Semigroup =
    htpy-product-fin-sequence-type-Semigroup (semigroup-Commutative-Semigroup G)
```
...
module _
  ...
  abstract
    ...
    preserves-product-permutation-list-adjacent-transpositions-Commutative-Semigroup :
      (n : ℕ) → (L : list (Fin n)) →
      (f : fin-sequence-type-Commutative-Semigroup G (succ-ℕ n)) →
      product-fin-sequence-type-Commutative-Semigroup G n f ＝
      product-fin-sequence-type-Commutative-Semigroup
    ...
    preserves-product-transposition-Commutative-Semigroup :
      (n : ℕ) (i j : Fin (succ-ℕ n)) (neq : i ≠ j) →
      (f : fin-sequence-type-Commutative-Semigroup G (succ-ℕ n)) →
      product-fin-sequence-type-Commutative-Semigroup G n f ＝
      product-fin-sequence-type-Commutative-Semigroup G n
        ( f ∘ map-transposition-Fin (succ-ℕ n) i j neq)
    preserves-product-transposition-Commutative-Semigroup n i j i≠j f =
      ( preserves-product-permutation-list-adjacent-transpositions-Commutative-Semigroup
        ( n)
    ...
    preserves-product-permutation-list-standard-transpositions-Commutative-Semigroup :
      (n : ℕ) →
