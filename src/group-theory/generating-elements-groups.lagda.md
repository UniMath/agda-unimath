...
[identification](foundation-core.identity-types.md) `g̃(1) = g` is [surjective](foundation.surjective-maps.md).
...
part of their structure, whereas cyclic groups are groups with the [property](foundation-core.propositions.md) that
there [exists](foundation.existential-quantification.md) a generating element.
