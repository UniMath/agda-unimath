...
Furthermore, we show that for any cyclic group, the evaluation map
...
module _
  ...
  abstract
    is-surjective-ev-element-is-generating-element-Group :
      is-surjective (ev-element-hom-Group G G g)
    is-surjective-ev-element-is-generating-element-Group x =
      apply-universal-property-trunc-Prop
        ( is-surjective-hom-element-is-generating-element-Group G g U x)
        ( subtype-im (ev-element-hom-Group G G g) x)
        ( λ { (k , refl) →
              unit-trunc-Prop
                ( hom-integer-multiple-Ab
                    ( abelian-group-generating-element-Group G (g , U))
                    ( k) ,
                  refl)})

  is-equiv-ev-element-is-generating-element-Group :
    is-equiv (ev-element-hom-Group G G g)
  is-equiv-ev-element-is-generating-element-Group =
    is-equiv-is-emb-is-surjective
      ( is-surjective-ev-element-is-generating-element-Group)
      ( is-emb-ev-element-is-generating-element-Group G g U G)

  is-iso-hom-ev-element-is-generating-element-Group :
    is-iso-hom-Ab
      ( ab-hom-Ab
        ( abelian-group-generating-element-Group G (g , U))
        ( abelian-group-generating-element-Group G (g , U)))
  ...
  iso-ev-element-is-generating-element-Group :
    iso-Ab
      ( ab-hom-Ab
        ( abelian-group-generating-element-Group G (g , U))
        ( abelian-group-generating-element-Group G (g , U)))
      ( abelian-group-generating-element-Group G (g , U))
  pr1 iso-ev-element-is-generating-element-Group =
    hom-ev-element-hom-Ab
      ( abelian-group-generating-element-Group G (g , U))
      ( abelian-group-generating-element-Group G (g , U))
      ( g)
  pr2 iso-ev-element-is-generating-element-Group =
    is-iso-hom-ev-element-is-generating-element-Group
```
