...
A {{#concept "morphism of pointed arrows"}} from a [pointed map](structured-types.pointed-maps.md) `f : A →∗ B` to a pointed map `g : X →∗ Y`
is a [triple](foundation.dependent-pair-types.md) `(i , j , H)` consisting of pointed maps `i : A →∗ X` and `j : B →∗ Y` and a
[pointed homotopy](structured-types.pointed-homotopies.md) `H : j ∘∗ f ~∗ g ∘∗ i` witnessing that
the square
...
[commutes](structured-types.commuting-squares-of-pointed-maps.md). Morphisms of pointed arrows
...
The {{#concept "transposition" Disambiguation="morphism of pointed arrows"}} of a morphism of pointed arrows
...
-- maps. The {{#concept "composition" Disambiguation="morphism of pointed-arrows"}} of `β : g → h` with `α : f → g` is therefore defined to be
...
--   {A : Pointed-Type l1} {B : Pointed-Type l2} {X : Pointed-Type l3} {Y : Pointed-Type l4} {U : UU l5} {V : UU l6}
--   (f : A → B) (g : X → Y) (h : U → V) (b : hom-pointed-arrow g h) (a : hom-pointed-arrow f g)
--   where

--   map-domain-comp-hom-pointed-arrow : A → U
--   map-domain-comp-hom-pointed-arrow =
--     map-domain-hom-pointed-arrow g h b ∘ map-domain-hom-pointed-arrow f g a

--   map-codomain-comp-hom-pointed-arrow : B → V
--   map-codomain-comp-hom-pointed-arrow =
--     map-codomain-hom-pointed-arrow g h b ∘ map-codomain-hom-pointed-arrow f g a
...
--       ( map-domain-hom-pointed-arrow g h b)
--       ( f)
--       ( g)
--       ( h)
--       ( map-codomain-hom-pointed-arrow f g a)
--       ( map-codomain-hom-pointed-arrow g h b)
--       ( coh-hom-pointed-arrow f g a)
--       ( coh-hom-pointed-arrow g h b)

--   comp-hom-pointed-arrow : hom-pointed-arrow f h
--   pr1 comp-hom-pointed-arrow =
--     map-domain-comp-hom-pointed-arrow
--   pr1 (pr2 comp-hom-pointed-arrow) =
--     map-codomain-comp-hom-pointed-arrow
--   pr2 (pr2 comp-hom-pointed-arrow) =
--     coh-comp-hom-pointed-arrow
-- ```

-- ### Homotopies of morphisms of pointed-arrows

-- A {{#concept "homotopy of morphisms of pointed-arrows"}} from `(i , j , H)` to `(i' , j' , H')` is
...
-- ```agda
-- module _
--   {l1 l2 l3 l4 : Level} {A : Pointed-Type l1} {B : Pointed-Type l2} {X : Pointed-Type l3} {Y : Pointed-Type l4}
--   (f : A → B) (g : X → Y) (α : hom-pointed-arrow f g)
--   where

--   coherence-htpy-hom-pointed-arrow :
--     (β : hom-pointed-arrow f g)
--     (I : map-domain-hom-pointed-arrow f g α ~ map-domain-hom-pointed-arrow f g β)
--     (J : map-codomain-hom-pointed-arrow f g α ~ map-codomain-hom-pointed-arrow f g β) →
--     UU (l1 ⊔ l4)
...
--     Σ ( map-domain-hom-pointed-arrow f g α ~ map-domain-hom-pointed-arrow f g β)
--       ( λ I →
--         Σ ( map-codomain-hom-pointed-arrow f g α ~ map-codomain-hom-pointed-arrow f g β)
...
--     htpy-domain-htpy-hom-pointed-arrow :
--       map-domain-hom-pointed-arrow f g α ~ map-domain-hom-pointed-arrow f g β
--     htpy-domain-htpy-hom-pointed-arrow = pr1 η

--     htpy-codomain-htpy-hom-pointed-arrow :
--       map-codomain-hom-pointed-arrow f g α ~ map-codomain-hom-pointed-arrow f g β
--     htpy-codomain-htpy-hom-pointed-arrow = pr1 (pr2 η)

--     coh-htpy-hom-pointed-arrow :
--       coherence-square-homotopies
--         ( htpy-codomain-htpy-hom-pointed-arrow ·r f)
--         ( coh-hom-pointed-arrow f g α)
--         ( coh-hom-pointed-arrow f g β)
--         ( g ·l htpy-domain-htpy-hom-pointed-arrow)
--     coh-htpy-hom-pointed-arrow = pr2 (pr2 η)

--   refl-htpy-hom-pointed-arrow : htpy-hom-pointed-arrow α
--   pr1 refl-htpy-hom-pointed-arrow = refl-htpy
--   pr1 (pr2 refl-htpy-hom-pointed-arrow) = refl-htpy
--   pr2 (pr2 refl-htpy-hom-pointed-arrow) = right-unit-htpy
...
--   htpy-eq-hom-pointed-arrow : (β : hom-pointed-arrow f g) → (α ＝ β) → htpy-hom-pointed-arrow β
...
--   is-equiv-htpy-eq-hom-pointed-arrow =
--     fundamental-theorem-id is-torsorial-htpy-hom-pointed-arrow htpy-eq-hom-pointed-arrow

--   extensionality-hom-pointed-arrow :
--     (β : hom-pointed-arrow f g) → (α ＝ β) ≃ htpy-hom-pointed-arrow β
--   pr1 (extensionality-hom-pointed-arrow β) = htpy-eq-hom-pointed-arrow β
--   pr2 (extensionality-hom-pointed-arrow β) = is-equiv-htpy-eq-hom-pointed-arrow β

--   eq-htpy-hom-pointed-arrow :
--     (β : hom-pointed-arrow f g) → htpy-hom-pointed-arrow β → α ＝ β
--   eq-htpy-hom-pointed-arrow β = map-inv-equiv (extensionality-hom-pointed-arrow β)
-- ```
...
--   (H : htpy-hom-pointed-arrow f g α β) (K : htpy-hom-pointed-arrow f g β γ)
--   where
...
--     ( ap
--       ( concat (coh-hom-pointed-arrow f g α a) (g (map-domain-hom-pointed-arrow f g γ a)))
--       ( ap-concat g
...
--   pr1 concat-htpy-hom-pointed-arrow = htpy-domain-concat-htpy-hom-pointed-arrow
--   pr1 (pr2 concat-htpy-hom-pointed-arrow) = htpy-codomain-concat-htpy-hom-pointed-arrow
--   pr2 (pr2 concat-htpy-hom-pointed-arrow) = coh-concat-htpy-hom-pointed-arrow
-- ```
...
-- module _
--   {l1 l2 l3 l4 : Level} {A : Pointed-Type l1} {B : Pointed-Type l2} {X : Pointed-Type l3} {Y : Pointed-Type l4}
--   (f : A → B) (g : X → Y) (α β : hom-pointed-arrow f g) (H : htpy-hom-pointed-arrow f g α β)
--   where
...
--   pr1 inv-htpy-hom-pointed-arrow = htpy-domain-inv-htpy-hom-pointed-arrow
--   pr1 (pr2 inv-htpy-hom-pointed-arrow) = htpy-codomain-inv-htpy-hom-pointed-arrow
--   pr2 (pr2 inv-htpy-hom-pointed-arrow) = coh-inv-htpy-hom-pointed-arrow
-- ```
...
--   {A : Pointed-Type l1} {B : Pointed-Type l2} {X : Pointed-Type l3} {Y : Pointed-Type l4} {U : UU l5} {V : UU l6}
--   (f : A → B) (g : X → Y) (h : U → V)
--   (γ : hom-pointed-arrow g h) (α β : hom-pointed-arrow f g) (H : htpy-hom-pointed-arrow f g α β)
--   where

--   htpy-domain-left-whisker-htpy-hom-pointed-arrow :
--     map-domain-comp-hom-pointed-arrow f g h γ α ~ map-domain-comp-hom-pointed-arrow f g h γ β
--   htpy-domain-left-whisker-htpy-hom-pointed-arrow =
--     map-domain-hom-pointed-arrow g h γ ·l htpy-domain-htpy-hom-pointed-arrow f g α β H
...
--   htpy-codomain-left-whisker-htpy-hom-pointed-arrow =
--     map-codomain-hom-pointed-arrow g h γ ·l htpy-codomain-htpy-hom-pointed-arrow f g α β H
...
--       ( ( ap
--           ( coh-hom-pointed-arrow g h γ (map-domain-hom-pointed-arrow f g α a) ∙_)
--           ( inv
--             ( ap-comp h
...
--       ( ( ap
--           ( ap (map-codomain-hom-pointed-arrow g h γ) (coh-hom-pointed-arrow f g α a) ∙_)
--           ( ap-comp
--             ( map-codomain-hom-pointed-arrow g h γ)
--             ( g)
--             ( htpy-domain-htpy-hom-pointed-arrow f g α β H a))) ∙
...
-- Then associativity of composition of morphisms of pointed-arrows follows directly from
...
--   (γ : hom-pointed-arrow h i) (β : hom-pointed-arrow g h) (α : hom-pointed-arrow f g)
--   where
