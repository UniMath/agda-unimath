...
module _
  ...
  right-whisk-coherence-triangle-homotopies-homotopies :
    {i : (x : A) → B x}
    (T : coherence-triangle-homotopies left right top) (H : i ~ f) →
    coherence-triangle-homotopies {f = i} (H ∙h left) right (H ∙h top)
  right-whisk-coherence-triangle-homotopies-homotopies T H =
