...
module _
  ...
  coherence-3-simplex-homotopies =
    ( upper-right ∙h
      left-whisk-coherence-triangle-homotopies-homotopies diagonal-up right upper-left) ~
    ( ( lower-left ∙h
        right-whisk-coherence-triangle-homotopies-homotopies right lower-right left) ∙h
