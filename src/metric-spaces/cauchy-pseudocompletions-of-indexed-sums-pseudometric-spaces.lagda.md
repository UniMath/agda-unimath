...
spaces; therefore,
{{#concept "the Cauchy pseudocompletion of an indexed sum is the indexed sum of the Cauchy pseudocompletions" Disambiguation="in pseudometric spaces" Agda=compute-cauchy-pseudocompletion-indexed-sum-Pseudometric-Space}}.
