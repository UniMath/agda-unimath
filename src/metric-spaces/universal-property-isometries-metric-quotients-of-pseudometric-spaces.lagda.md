...
`q`, i.e., an isometry `g : [P] → M` such that
...
### Precomposition of isometries by the unit map of metric quotients
...
module _
  ...
  is-short-map-exten-isometry-metric-quotient-Pseudometric-Space :
  ...
  is-expansive-map-exten-isometry-metric-quotient-Pseudometric-Space :
