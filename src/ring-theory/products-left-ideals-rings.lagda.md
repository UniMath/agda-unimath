...
The **product** of two [left ideals](ring-theory.left-ideals-rings.md) `I` and `J` in a
[ring](ring-theory.rings.md) is the left ideal [generated by](ring-theory.left-ideals-generated-by-subsets-rings.md) all products of elements in
`I` and `J`.
