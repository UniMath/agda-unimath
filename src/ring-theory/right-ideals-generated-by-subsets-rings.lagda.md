...
module _
  ...
  ev-right-formal-combination-subset-Ring (cons (s , r) l) =
    add-Ring R
  ...
  contains-zero-right-ideal-subset-Ring = unit-trunc-Prop (nil , refl)
  ...
  pr1
    ( is-closed-under-addition-right-ideal-subset-Ring' (l , p) (k , q)) =
    concat-list l k
  pr2
    ( is-closed-under-addition-right-ideal-subset-Ring' (l , p) (k , q)) =
  ...
  is-closed-under-addition-right-ideal-subset-Ring H K =
    apply-universal-property-trunc-Prop H
      ( subset-right-ideal-subset-Ring _)
      ( λ H' →
  ...
  is-additive-submonoid-right-ideal-subset-Ring :
    is-additive-submonoid-subset-Ring R subset-right-ideal-subset-Ring
  pr1 is-additive-submonoid-right-ideal-subset-Ring =
    contains-zero-right-ideal-subset-Ring
  pr2 is-additive-submonoid-right-ideal-subset-Ring =
    is-closed-under-addition-right-ideal-subset-Ring
  ...
  pr1
    ( is-closed-under-right-multiplication-right-ideal-subset-Ring' (l , p)) =
    mul-right-formal-combination-subset-Ring l _
  pr2
    ( is-closed-under-right-multiplication-right-ideal-subset-Ring' (l , p)) =
    ( preserves-mul-ev-right-formal-combination-subset-Ring l _) ∙
    ( ap (mul-Ring' R _) p)

  is-closed-under-right-multiplication-right-ideal-subset-Ring :
    is-closed-under-right-multiplication-subset-Ring R
      subset-right-ideal-subset-Ring
  is-closed-under-right-multiplication-right-ideal-subset-Ring H =
    apply-universal-property-trunc-Prop H
      ( subset-right-ideal-subset-Ring _)
      ( λ H' →
        unit-trunc-Prop
  ...
  pr1 right-ideal-subset-Ring =
    subset-right-ideal-subset-Ring
  pr1 (pr2 right-ideal-subset-Ring) =
    is-additive-submonoid-right-ideal-subset-Ring
  ...
  contains-right-formal-combinations-right-ideal-subset-Ring I H
    ...
    is-closed-under-addition-right-ideal-Ring R I
      ( is-closed-under-right-multiplication-right-ideal-Ring R I (H s K))
...
module _
  ...
  cases-forward-inclusion-idempotent-right-ideal-subset-Ring
    ( cons ((x , u) , y) l) =
    is-closed-under-addition-right-ideal-Ring R I
      ( is-closed-under-right-multiplication-right-ideal-Ring R I u)
