...
The [ideals](ring-theory.ideals-semirings.md) of a
...
module _
  ...
  leq-prop-ideal-Semiring :
    {l2 l3 : Level} →
    ideal-Semiring l2 R → ideal-Semiring l3 R → Prop (l1 ⊔ l2 ⊔ l3)
  ...
  leq-ideal-Semiring :
    {l2 l3 : Level} →
    ideal-Semiring l2 R → ideal-Semiring l3 R → UU (l1 ⊔ l2 ⊔ l3)
...
module _
  ...
  eq-sim-ideal-Semiring :
    {l2 : Level}
    (I J : ideal-Semiring l2 R) → sim-ideal-Semiring I J → I ＝ J
  eq-sim-ideal-Semiring = eq-sim-Large-Poset (ideal-Semiring-Large-Poset R)

  has-same-elements-sim-ideal-Semiring :
    {l2 l3 : Level}
    (I : ideal-Semiring l2 R) (J : ideal-Semiring l3 R) →
    sim-ideal-Semiring I J →
    has-same-elements-ideal-Semiring R I J
  pr1 (has-same-elements-sim-ideal-Semiring I J H x) =
    pr1 H x
  pr2 (has-same-elements-sim-ideal-Semiring I J H x) =
    pr2 H x

  sim-has-same-elements-ideal-Semiring :
    {l2 l3 : Level}
    (I : ideal-Semiring l2 R) (J : ideal-Semiring l3 R) →
    has-same-elements-ideal-Semiring R I J →
    sim-ideal-Semiring I J
  pr1 (sim-has-same-elements-ideal-Semiring I J H) x = pr1 (H x)
  pr2 (sim-has-same-elements-ideal-Semiring I J H) x = pr2 (H x)
```
...
module _
  ...
  preserves-order-subset-ideal-Semiring :
    {l1 l2 : Level}
    (I : ideal-Semiring l1 R) (J : ideal-Semiring l2 R) →
