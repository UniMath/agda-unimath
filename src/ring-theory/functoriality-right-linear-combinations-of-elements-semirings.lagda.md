...
### Functoriality preserves right linear combinations of a single element in a semiring
...
module _
  ...
  map-right-linear-combination-element-Semiring :
    right-linear-combination-element-Semiring R a →
    right-linear-combination-element-Semiring S (map-hom-Semiring R S f a)
  map-right-linear-combination-element-Semiring =
    map-right-linear-combination-subset-Semiring R S f
  ...
  preserves-ev-map-right-linear-combination-element-Semiring :
    (l : right-linear-combination-element-Semiring R a) →
    map-hom-Semiring R S f
      ( ev-right-linear-combination-element-Semiring R a l) ＝
    ev-right-linear-combination-element-Semiring S (map-hom-Semiring R S f a)
      ( map-right-linear-combination-element-Semiring l)
  preserves-ev-map-right-linear-combination-element-Semiring =
    preserves-ev-map-right-linear-combination-subset-Semiring R S f
      ( subtype-standard-singleton-subtype
        ( set-Semiring R)
  ...
  map-is-right-linear-combination-element-Semiring :
    (x : type-Semiring R) →
    is-right-linear-combination-element-Semiring R a x →
    is-right-linear-combination-element-Semiring S
      ( map-hom-Semiring R S f a)
      ( map-hom-Semiring R S f x)
  map-is-right-linear-combination-element-Semiring =
    map-is-right-linear-combination-subset-Semiring R S f
