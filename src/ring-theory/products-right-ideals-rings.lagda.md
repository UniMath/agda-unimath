...
The **product** of two [right ideals](ring-theory.right-ideals-rings.md) `I` and `J` in a
[ring](ring-theory.rings.md) is the right ideal [generated by](ring-theory.right-ideals-generated-by-subsets-rings.md) all products of elements in
`I` and `J`.
