...
module _
  ...
  mul-right-linear-combination-Semiring :
    ...
    type-Semiring R →
    right-linear-combination-Semiring R A
  mul-right-linear-combination-Semiring x r =
    map-list (λ (a , s) → (a , mul-Semiring R s r)) x
```

### Evaluating right linear combinations of elements
...
module _
  ...
  ev-monoid-right-linear-combination-Semiring M =
    ev-unital-magma-right-linear-combination-Semiring (unital-magma-Monoid M)
```
...
module _
  ...
  right-scalar-multiplication-subset-Semiring :
    type-subset-Semiring R S → type-Semiring R → type-Semiring R
  right-scalar-multiplication-subset-Semiring s r =
    mul-Semiring R (inclusion-subset-Semiring R S s) r
  ...
  is-mere-right-linear-combination-subset-Semiring :
    type-Semiring R → UU (l1 ⊔ l2)
  is-mere-right-linear-combination-subset-Semiring =
    is-in-subtype is-mere-right-linear-combination-prop-subset-Semiring
```
...
module _
  ...
  ev-right-linear-combination-family-of-elements-Semiring =
    ev-right-linear-combination-subset-Semiring R (trunc-Prop ∘ fiber a)
