...
module _
  ...
  map-norm-neg-Normed-ℝ-Vector-Space :
    (x : type-Normed-ℝ-Vector-Space V) →
    map-norm-Normed-ℝ-Vector-Space V (neg-Normed-ℝ-Vector-Space V x) ＝
    map-norm-Normed-ℝ-Vector-Space V x
  map-norm-neg-Normed-ℝ-Vector-Space =
    seminorm-neg-Seminormed-ℝ-Vector-Space
      ( seminormed-vector-space-Normed-ℝ-Vector-Space V)

  nonnegative-norm-neg-Normed-ℝ-Vector-Space :
    (x : type-Normed-ℝ-Vector-Space V) →
    nonnegative-norm-Normed-ℝ-Vector-Space V (neg-Normed-ℝ-Vector-Space V x) ＝
    nonnegative-norm-Normed-ℝ-Vector-Space V x
  nonnegative-norm-neg-Normed-ℝ-Vector-Space x =
    eq-ℝ⁰⁺ _ _ (map-norm-neg-Normed-ℝ-Vector-Space x)
