...
The
{{#concept "dot product" WDID=Q181365 WD="scalar product" Disambiguation="of vectors in ℝⁿ" Agda=dot-product-fin-sequence-ℝ}}
...
```agda
dot-product-fin-sequence-ℝ :
  {n : ℕ} {l : Level} → type-fin-sequence-ℝ n l → type-fin-sequence-ℝ n l → ℝ l
dot-product-fin-sequence-ℝ {n} u v = sum-fin-sequence-ℝ n (λ i → u i *ℝ v i)
```
...
abstract
  symmetric-dot-product-fin-sequence-ℝ :
    ...
    dot-product-fin-sequence-ℝ u v ＝ dot-product-fin-sequence-ℝ v u
  symmetric-dot-product-fin-sequence-ℝ {n} u v =
...
```agda
abstract
  left-distributive-dot-product-add-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (u v w : type-fin-sequence-ℝ n l) →
    dot-product-fin-sequence-ℝ u (add-fin-sequence-ℝ v w) ＝
    dot-product-fin-sequence-ℝ u v +ℝ dot-product-fin-sequence-ℝ u w
  left-distributive-dot-product-add-fin-sequence-ℝ {n} u v w =
    ( htpy-sum-fin-sequence-ℝ
      ( n)
      ( λ i → left-distributive-mul-add-ℝ (u i) (v i) (w i))) ∙
    ( inv (interchange-add-sum-fin-sequence-ℝ _ _ _))

  right-distributive-dot-product-add-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (u v w : type-fin-sequence-ℝ n l) →
    dot-product-fin-sequence-ℝ (add-fin-sequence-ℝ u v) w ＝
    dot-product-fin-sequence-ℝ u w +ℝ dot-product-fin-sequence-ℝ v w
  right-distributive-dot-product-add-fin-sequence-ℝ {n} u v w =
    ( htpy-sum-fin-sequence-ℝ
      ( n)
...
```agda
abstract
  preserves-left-scalar-mul-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (c : ℝ l) (u v : type-fin-sequence-ℝ n l) →
    dot-product-fin-sequence-ℝ (mul-fin-sequence-ℝ c u) v ＝
    c *ℝ dot-product-fin-sequence-ℝ u v
  preserves-left-scalar-mul-fin-sequence-ℝ {n} c u v =
    ( htpy-sum-fin-sequence-ℝ n (λ i → associative-mul-ℝ c (u i) (v i))) ∙
    ( inv (left-distributive-mul-sum-fin-sequence-ℝ n c _))

  preserves-right-scalar-mul-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (c : ℝ l) (u v : type-fin-sequence-ℝ n l) →
    dot-product-fin-sequence-ℝ u (mul-fin-sequence-ℝ c v) ＝
    c *ℝ dot-product-fin-sequence-ℝ u v
  preserves-right-scalar-mul-fin-sequence-ℝ {n} c u v =
...
```agda
bilinear-form-dot-product-fin-sequence-ℝ :
  (n : ℕ) (l : Level) →
  bilinear-form-ℝ-Vector-Space (vector-space-fin-sequence-ℝ n l)
...
abstract
  is-nonnegative-diagonal-dot-product-fin-sequence-ℝ :
    ...
    is-nonnegative-ℝ (dot-product-fin-sequence-ℝ v v)
  is-nonnegative-diagonal-dot-product-fin-sequence-ℝ {n} v =
    is-nonnegative-real-sum-fin-sequence-ℝ⁰⁺
      ( n)
      ( λ i → nonnegative-square-ℝ (v i))

nonnegative-diagonal-dot-product-fin-sequence-ℝ :
  {n : ℕ} {l : Level} (v : type-fin-sequence-ℝ n l) → ℝ⁰⁺ l
nonnegative-diagonal-dot-product-fin-sequence-ℝ v =
  ( dot-product-fin-sequence-ℝ v v ,
    is-nonnegative-diagonal-dot-product-fin-sequence-ℝ v)
```
...
```agda
abstract
  htpy-zero-is-zero-diagonal-dot-product-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (v : type-fin-sequence-ℝ n l) →
    is-zero-ℝ (dot-product-fin-sequence-ℝ v v) →
    (i : Fin n) → v i ＝ raise-zero-ℝ l
  htpy-zero-is-zero-diagonal-dot-product-fin-sequence-ℝ {n} v v·v=0 i =
  ...
  extensionality-dot-product-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (v : type-fin-sequence-ℝ n l) →
    is-zero-ℝ (dot-product-fin-sequence-ℝ v v) → v ＝ zero-fin-sequence-ℝ n l
  extensionality-dot-product-fin-sequence-ℝ v v·v=0 =
    eq-htpy (htpy-zero-is-zero-diagonal-dot-product-fin-sequence-ℝ v v·v=0)
```
...
abstract
  leq-mul-dimension-bound-dot-product-fin-sequence-ℝ :
    (n : ℕ) {l1 l2 : Level} (v : type-fin-sequence-ℝ n l1) (ε : ℝ⁰⁺ l2) →
    ((i : Fin n) → leq-ℝ (abs-ℝ (v i)) (real-ℝ⁰⁺ ε)) →
    leq-ℝ (dot-product-fin-sequence-ℝ v v) (real-ℕ n *ℝ square-ℝ (real-ℝ⁰⁺ ε))
  leq-mul-dimension-bound-dot-product-fin-sequence-ℝ n v ε |vᵢ|≤ε =
...
```agda
abstract
  leq-square-diagonal-dot-product-fin-sequence-ℝ :
    {n : ℕ} {l : Level} (v : type-fin-sequence-ℝ n l) (i : Fin n) →
    leq-ℝ (square-ℝ (v i)) (dot-product-fin-sequence-ℝ v v)
  leq-square-diagonal-dot-product-fin-sequence-ℝ {n} v =
...
abstract
  leq-abs-sqrt-diagonal-dot-product-fin-sequence-ℝ :
    ...
    leq-ℝ
      ( abs-ℝ (v i))
      ( real-sqrt-ℝ⁰⁺ (nonnegative-diagonal-dot-product-fin-sequence-ℝ v))
  leq-abs-sqrt-diagonal-dot-product-fin-sequence-ℝ {n} v i =
    binary-tr
      ( leq-ℝ)
      ...
      ( preserves-leq-sqrt-ℝ⁰⁺
        ...
        ( nonnegative-diagonal-dot-product-fin-sequence-ℝ v)
        ( leq-square-diagonal-dot-product-fin-sequence-ℝ v i))
```
