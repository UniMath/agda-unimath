...
module _
  ...
  non-trivial-tuple-linearly-dependent-repeated-element-tuple-left-module-Ring n i j =
    ( with-value-tuple i
      ( one-Ring R)
  ...
  gives-zero-linearly-dependent-repeated-element-tuple :
    ...
    linear-combination-tuple-left-module-Ring R M
      ...
      ( vectors) ＝
    zero-left-module-Ring R M
  gives-zero-linearly-dependent-repeated-element-tuple n vectors i j i≠j identity = {! !}
