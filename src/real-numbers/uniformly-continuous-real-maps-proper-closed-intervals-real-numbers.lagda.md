...
module real-numbers.uniformly-continuous-real-maps-proper-closed-intervals-real-numbers where
```
...
A
{{#concept "uniformly continuous map" Disambiguation="from a proper closed interval in ℝ to ℝ" Agda=uniformly-continuous-real-map-proper-closed-interval-ℝ}}
from a
...
uniformly-continuous-real-map-proper-closed-interval-ℝ :
...
module _
  ...
  map-uniformly-continuous-real-map-proper-closed-interval-ℝ :
    type-proper-closed-interval-ℝ l1 [a,b] → ℝ l2
  map-uniformly-continuous-real-map-proper-closed-interval-ℝ = pr1 f
  ...
  subset-im-uniformly-continuous-real-map-proper-closed-interval-ℝ =
    subtype-im map-uniformly-continuous-real-map-proper-closed-interval-ℝ
