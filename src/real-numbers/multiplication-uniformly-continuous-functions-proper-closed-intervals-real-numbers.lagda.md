...
module _
  ...
  map-mul-uniformly-continuous-function-proper-closed-interval-ℝ x =
    pr1 f x *ℝ pr1 g x

  abstract
    is-uniformly-continuous-map-mul-uniformly-continuous-function-proper-closed-interval-ℝ :
  ...
  mul-uniformly-continuous-function-proper-closed-interval-ℝ :
    uniformly-continuous-function-proper-closed-interval-ℝ l1 (l2 ⊔ l3) [a,b]
  mul-uniformly-continuous-function-proper-closed-interval-ℝ =
    ( map-mul-uniformly-continuous-function-proper-closed-interval-ℝ ,
      is-uniformly-continuous-map-mul-uniformly-continuous-function-proper-closed-interval-ℝ)
```
