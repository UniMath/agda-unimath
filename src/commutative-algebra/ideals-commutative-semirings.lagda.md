...
module _
  ...
  is-ideal-is-right-ideal-subset-Commutative-Semiring :
    is-right-ideal-subset-Commutative-Semiring →
    is-ideal-subset-Commutative-Semiring
  pr1 (is-ideal-is-right-ideal-subset-Commutative-Semiring (H , K)) = H
  pr2 (is-ideal-is-right-ideal-subset-Commutative-Semiring (H , K)) U =
  ...
  is-right-ideal-is-ideal-subset-Commutative-Semiring :
    is-ideal-subset-Commutative-Semiring →
    is-right-ideal-subset-Commutative-Semiring
  pr1 (is-right-ideal-is-ideal-subset-Commutative-Semiring (H , K)) = H
  pr2 (is-right-ideal-is-ideal-subset-Commutative-Semiring (H , K)) U =
    is-closed-under-eq-subset-Commutative-Semiring A S
      ( K U)
      ( commutative-mul-Commutative-Semiring A _ _)
  ...
  is-ideal-is-two-sided-ideal-subset-Commutative-Semiring :
    is-two-sided-ideal-subset-Commutative-Semiring →
    is-ideal-subset-Commutative-Semiring
  pr1 (is-ideal-is-two-sided-ideal-subset-Commutative-Semiring (H , K)) = H
  pr2 (is-ideal-is-two-sided-ideal-subset-Commutative-Semiring (H , K)) U =
    is-closed-under-eq-subset-Commutative-Semiring A S
      ( K U)
  ...
  is-two-sided-ideal-is-ideal-subset-Commutative-Semiring :
    is-ideal-subset-Commutative-Semiring →
    is-two-sided-ideal-subset-Commutative-Semiring
  pr1 (is-two-sided-ideal-is-ideal-subset-Commutative-Semiring (H , K)) = H
  pr2 (is-two-sided-ideal-is-ideal-subset-Commutative-Semiring (H , K)) U =
    is-closed-under-eq-subset-Commutative-Semiring A S
      ( K (K U))
      ( commutative-mul-Commutative-Semiring A _ _)
```
...
module _
  ...
  subset-ideal-Commutative-Semiring =
    subset-left-ideal-Semiring (semiring-Commutative-Semiring A) I

  is-ideal-ideal-Commutative-Semiring :
    is-ideal-subset-Commutative-Semiring A subset-ideal-Commutative-Semiring
  is-ideal-ideal-Commutative-Semiring =
    is-left-ideal-left-ideal-Semiring (semiring-Commutative-Semiring A) I
  ...
  ap-inclusion-ideal-Commutative-Semiring =
    ap-inclusion-left-ideal-Semiring (semiring-Commutative-Semiring A) I
  ...
  is-closed-under-eq-ideal-Commutative-Semiring =
    is-closed-under-eq-left-ideal-Semiring (semiring-Commutative-Semiring A) I
  ...
  contains-zero-ideal-Commutative-Semiring :
    contains-zero-subset-Commutative-Semiring A
      subset-ideal-Commutative-Semiring
  contains-zero-ideal-Commutative-Semiring =
    contains-zero-left-ideal-Semiring (semiring-Commutative-Semiring A) I
...
```agda
module _
  {l1 l2 l3 : Level} (A : Commutative-Semiring l1) (I : ideal-Commutative-Semiring l2 A)
  where
...
module _
  {l1 l2 : Level} (A : Commutative-Semiring l1) (I : ideal-Commutative-Semiring l2 A)
  where
