# The product rule on derivatives of real functions on proper closed intervals

```agda
{-# OPTIONS --lossy-unification #-}

module analysis.product-rule-derivatives-of-real-functions-on-proper-closed-intervals where
```
...
The
{{#concept "product rule" Agda=derivative-mul-uniformly-continuous-function-proper-closed-interval-ℝ}}
for
...
module _
  ...
  (g : uniformly-continuous-function-proper-closed-interval-ℝ l1 l3 [a,b])
  (f' :
    uniformly-continuous-function-proper-closed-interval-ℝ l1 (l1 ⊔ l2) [a,b])
  (g' :
    uniformly-continuous-function-proper-closed-interval-ℝ l1 (l1 ⊔ l3) [a,b])
  (is-derivative-f-f' :
    is-derivative-real-function-proper-closed-interval-ℝ
      ( [a,b])
      ( map-uniformly-continuous-function-proper-closed-interval-ℝ [a,b] f)
      ( map-uniformly-continuous-function-proper-closed-interval-ℝ [a,b] f'))
  (is-derivative-g-g' :
    is-derivative-real-function-proper-closed-interval-ℝ
      ( [a,b])
      ( map-uniformly-continuous-function-proper-closed-interval-ℝ [a,b] g)
      ( map-uniformly-continuous-function-proper-closed-interval-ℝ [a,b] g'))
  where
  ...
  map-derivative-mul-real-function-proper-closed-interval-ℝ x =
    let
      map :
        {l4 : Level} →
        uniformly-continuous-function-proper-closed-interval-ℝ l1 l4 [a,b] →
        type-proper-closed-interval-ℝ l1 [a,b] → ℝ l4
      map = map-uniformly-continuous-function-proper-closed-interval-ℝ [a,b]
    in map f x *ℝ map g' x +ℝ map f' x *ℝ map g x

  abstract
    derivative-mul-uniformly-continuous-function-proper-closed-interval-ℝ :
      is-derivative-real-function-proper-closed-interval-ℝ
        ( [a,b])
        ( map-mul-uniformly-continuous-function-proper-closed-interval-ℝ
          ( [a,b])
          ( f)
          ( g))
        ( map-derivative-mul-real-function-proper-closed-interval-ℝ)
