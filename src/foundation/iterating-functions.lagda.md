...
module foundation.iterating-functions
...
open import elementary-number-theory.multiplicative-monoid-of-natural-numbers funext univalence truncations
...
open import group-theory.monoid-actions funext univalence truncations
```
