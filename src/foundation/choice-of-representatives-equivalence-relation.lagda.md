...
module _
  ...
  is-choice-of-representatives P =
    (a : A) → is-contr (Σ A (λ x → P x × sim-Eq-Relation R a x))
          ...
          unit-trunc-Prop
            ( pair
              ...
              ( ( apply-effectiveness-class' R
                  ( symmetric-Eq-Relation R _ _ (pr2 (pr2 (center (H a)))))) ∙
                ( eq-class-equivalence-class R
                  ( pair Q K)
                  ( backward-implication
                    ( φ a)
                    ( refl-Eq-Relation R _))))))
  ...
  abstract
    ...
    is-emb-class-representatives {P} H (pair a p) =
      fundamental-theorem-id
        ( is-contr-equiv
          ( Σ A (λ x → P x × sim-Eq-Relation R a x))
          ( ( associative-Σ A P (λ z → sim-Eq-Relation R a (pr1 z))) ∘e
            ( equiv-tot
              ( λ t →
