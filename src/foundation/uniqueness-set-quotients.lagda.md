...
precomp-comp-Set-Quotient :
  {l1 l2 l3 l4 l5 : Level} {A : UU l1} (R : Eq-Relation l2 A)
...
precomp-comp-Set-Quotient R B f C g D h =
  eq-htpy-reflecting-map-Eq-Relation R D
    ( precomp-Set-Quotient R B f D (h ∘ g))
    ( precomp-Set-Quotient R C (precomp-Set-Quotient R B f C g) D h)
    ( refl-htpy)

module _
  {l1 l2 l3 l4 : Level} {A : UU l1} (R : Eq-Relation l2 A)
  (B : Set l3) (f : reflecting-map-Eq-Relation R (type-Set B))
        ...
        ( ( ap
            ...
            ( eq-htpy-reflecting-map-Eq-Relation R B
              ...
              ( triangle-universal-property-set-quotient-is-set-quotient
                R C g Ug B f))) ∙
          ( ( eq-htpy-reflecting-map-Eq-Relation R C
  ...
  is-set-quotient-is-set-quotient-is-equiv E Uf {l} X =
    is-equiv-comp-htpy
      ...
      ( λ k →
        eq-htpy-reflecting-map-Eq-Relation R X
...
module _
  ...
  uniqueness-set-quotient :
    is-contr
      ( Σ ( type-Set B ≃ type-Set C)
          ( λ e →
            ( map-equiv e ∘ map-reflecting-map-Eq-Relation R f) ~
            ( map-reflecting-map-Eq-Relation R g)))
  uniqueness-set-quotient =
  ...
  triangle-uniqueness-set-quotient :
    ( map-equiv-uniqueness-set-quotient ∘ map-reflecting-map-Eq-Relation R f) ~
    ( map-reflecting-map-Eq-Relation R g)
  triangle-uniqueness-set-quotient =
