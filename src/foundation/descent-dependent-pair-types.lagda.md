...
module _
  ...
  triangle-descent-Σ :
    (i : I) (a : A i) →
    ( map-fiber-vertical-cone (f i) h (c i) a) ~
    ( ( map-fiber-vertical-cone (ind-Σ f) h cone-descent-Σ (pair i a)) ∘
  ...
  abstract
    ...
    descent-Σ' is-pb-dsq i =
      is-pullback-is-fiberwise-equiv-map-fiber-vertical-cone (f i) h (c i)
        ( λ a →
