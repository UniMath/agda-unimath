...
A homotopy of identifications is a pointwise equality between dependent functions. We defined homotopies in [`foundation-core.homotopies`](https://unimath.github.io/agda-unimath/foundation-core.homotopies.html). In this file, we record some properties of homotopies that require function extensionality.
...
module _
  ...
  is-equiv-inv-con-htpy :
    (H : f ~ g) (K : g ~ h) (L : f ~ h) → is-equiv (inv-con-htpy H K L)
  ...
  is-equiv-con-inv-htpy :
    ( H : f ~ g) (K : g ~ h) (L : f ~ h) → is-equiv (con-inv-htpy H K L)
