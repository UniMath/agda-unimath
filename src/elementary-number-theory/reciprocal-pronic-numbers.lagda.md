# The reciprocal pronic numbers

```agda
module elementary-number-theory.reciprocal-pronic-numbers where
```
...
A
{{#concept "reciprocal pronic number" Agda=reciprocal-pronic-number-ℚ}}
...
where $n(n+1)$ is the $n$th [pronic number](elementary-number-theory.pronic-numbers.md) for some $n>0$.

## Definitions

### Reciprocal pronic numbers

```agda
reciprocal-pronic-number-succ-ℕ : ℕ → ℚ
reciprocal-pronic-number-succ-ℕ n =
  reciprocal-rational-ℕ⁺ (nonzero-pronic-number-succ-ℕ n)

reciprocal-pronic-number-ℕ : (n : ℕ) → is-nonzero-ℕ n → ℚ
reciprocal-pronic-number-ℕ n = ?
```

### The sum of the reciprocals of the first `n` nonzero pronic numbers is `2(1-1/(n+1))`

```agda
abstract
  compute-reciprocal-pronic-number-succ-ℕ :
    (n : ℕ) →
    reciprocal-pronic-number-succ-ℕ n ＝
    rational-ℕ 2 *ℚ
    reciprocal-rational-ℕ⁺ (succ-nonzero-ℕ' n *ℕ⁺ succ-nonzero-ℕ' (succ-ℕ n))
  compute-reciprocal-pronic-number-succ-ℕ n =
    ap
      ( rational-ℚ⁺)
      ( equational-reasoning
        inv-ℚ⁺ (positive-rational-ℕ⁺ (nonzero-pronic-number-succ-ℕ n))
        ＝
          two-ℚ⁺ *ℚ⁺
          ( inv-ℚ⁺ two-ℚ⁺ *ℚ⁺
            inv-ℚ⁺ (positive-rational-ℕ⁺ (nonzero-pronic-number-succ-ℕ n)))
          by
            inv
              ( is-section-left-div-Group
                ...
                ( inv-ℚ⁺
                  ( positive-rational-ℕ⁺ (nonzero-pronic-number-succ-ℕ n))))
        ＝
          two-ℚ⁺ *ℚ⁺
          ( inv-ℚ⁺
            ( two-ℚ⁺ *ℚ⁺
        ...
        ＝
          ...
          ( inv-ℚ⁺
            ( positive-rational-ℕ⁺
              ( 2 *ℕ pronic-number-ℕ (succ-ℕ n) , λ ())))
          by
            ap-mul-ℚ⁺
              ( refl)
              ( ap
                ( inv-ℚ⁺)
                ( eq-ℚ⁺ (mul-rational-ℕ 2 (pronic-number-ℕ (succ-ℕ n)))))
        ＝
          two-ℚ⁺ *ℚ⁺
          ...
          by
            ap-mul-ℚ⁺
              ...
              ( ap
                ( positive-reciprocal-rational-ℕ⁺)
                ( eq-nonzero-ℕ
                  ( compute-double-pronic-number-ℕ (succ-ℕ n)))))

series-reciprocal-pronic-number-ℕ : series-ℚ
series-reciprocal-pronic-number-ℕ =
  series-terms-ℚ reciprocal-pronic-number-succ-ℕ

abstract
  compute-partial-sum-series-reciprocal-pronic-number-ℕ :
    (n : ℕ) →
    partial-sum-series-ℚ
      ( series-reciprocal-pronic-number-ℕ)
      ( n) ＝
    rational-ℕ 2 *ℚ (one-ℚ -ℚ reciprocal-rational-succ-ℕ n)
  compute-partial-sum-series-reciprocal-pronic-number-ℕ 0 =
    inv
      ( equational-reasoning
  ...
  compute-partial-sum-series-reciprocal-pronic-number-ℕ (succ-ℕ n) =
    equational-reasoning
      partial-sum-series-ℚ
        ( series-reciprocal-pronic-number-ℕ)
        ( n) +ℚ
      ...
      ＝
        ...
        by
          ap-add-ℚ
            ( compute-partial-sum-series-reciprocal-pronic-number-ℕ n)
            ( compute-reciprocal-pronic-number-succ-ℕ n)
      ＝
        rational-ℕ 2 *ℚ
...
### The sum of reciprocals of pronic numbers converges to 2
...
```agda
abstract
  sum-reciprocal-pronic-number-ℕ :
    is-sum-series-ℚ
      ( series-reciprocal-pronic-number-ℕ)
      ( rational-ℕ 2)
  sum-reciprocal-pronic-number-ℕ =
    binary-tr
      ...
      ( inv (eq-htpy compute-partial-sum-series-reciprocal-pronic-number-ℕ))
      ( equational-reasoning
