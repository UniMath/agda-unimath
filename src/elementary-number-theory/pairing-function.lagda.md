...
A pairing function is a process to uniquely encode two natural numbers into a single natural number. In other words, a pairing function is a bijection from `ℕ × ℕ` to `ℕ`.
