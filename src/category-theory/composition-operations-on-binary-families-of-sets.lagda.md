...
associativity witness in _both_ directions. This is of course redundant, as
`inv` is a [fibered involution](foundation.fibered-involutions.md) on
[identity types](foundation-core.identity-types.md). However, by recording both
directions, we maintain a _definitional_ double inverse law, which is useful in
