...
module _
  ...
  associative-compose-hom-Groupoid :
  ...
  associative-compose-hom-Groupoid = associative-compose-hom-Cat cat-Groupoid
...
module _
  ...
  pr2 (pr1 (pr2 (pr2 precat-groupoid-1-Type))) r q p = inv (associative p q r)
