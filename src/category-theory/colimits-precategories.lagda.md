...
module _
  ...
  has-colimits-Precategory : (l3 l4 : Level) → UU (l1 ⊔ l2 ⊔ lsuc l3 ⊔ lsuc l4)
  has-colimits-Precategory l3 l4 =
    (J : Precategory l3 l4) → (F : functor-Precategory J C) →
    colimit-Precategory J C F
```
